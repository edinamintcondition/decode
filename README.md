...
This res contains the public FTC SDK for the DECODE (2025-2026) competition season.
...
### Sample OpModes
This project contains a large selecton of Sample OpModes (robot code examples) which can be cut and pasted into your /teamcode folder to be used as-is, or modified to suit your team's needs.
