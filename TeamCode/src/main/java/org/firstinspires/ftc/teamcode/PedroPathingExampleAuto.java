...
public class PedroPathingExampleAuto extends LinearOpMode {
    ...
    private final Pose startPose = new Pose(28.5, 128, Math.toRadians(180)); // Start Pose of our robot.  n
    private final Pose scorePose = new Pose(38, 123, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
